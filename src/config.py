...
DATA_CONFIG = {
    ...
    'num_frames': 64,          # Increased number of frames per video for better temporal coverage
...
MODEL_CONFIG = {
    ...
    'cnn_lstm': {
        'hidden_size': 512,     # Increased LSTM hidden dimension
        ...
        'lstm_units': [512, 256],  # Increased units in LSTM layers
